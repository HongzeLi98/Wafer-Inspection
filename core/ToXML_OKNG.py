...
def toxml(AsebPath, SocPath, newname, OKNum, NGNum):       #自定义输入数字
    shutil.copy(SocPath[0]+ '\\' + 'WaferTemplate.xml', AsebPath[4]+ '\\' + newname + '_Front.xml')
    ...
    shutil.copy(SocPath[0] + '\\' + 'WaferTemplate.xml', AsebPath[7]+ '\\' + newname + '_Back.xml')
...
# --------------将之前两个xml文件合并----------------- #
    ...
    #先生成一个前道工序图
    shutil.copy(SocPath[0] + '\\' + 'WaferTemplate.xml', AsebPath[8]+ '\\' + newname + '_OIM328' + '.xml')
    ...
    # 生成最终的map图
    shutil.copy(SocPath[1] + '\\' + 'FinalWaferTemplate.xml', AsebPath[8]+ '\\' + newname + '.xml')
